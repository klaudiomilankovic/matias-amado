      ...
      <section className="px-6 lg:px-14 py-12 lg:py-20 flex flex-col lg:flex-row gap-12 mx-auto max-w-7xl">
        <div>
          <div className="mb-6 grid grid-cols-2 gap-x-6">
            <h1 className="text-4xl md:text-5xl font-bold">Cirugía de mamas</h1>
          </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <article className="flex flex-col gap-y-2 text-center items-start">
                    ...
                    <div className="aspect-[4/6]">
                      <img
                        ...
                        src="/images/mamas-refe-1.jpg"
                        alt="Foto de frente. Desde altura de cintrura hacia arriba."
                      />
                    </div>
                    <input
                  ...
                  <article className="flex flex-col gap-y-2 text-center items-start">
                    ...
                    <div className="aspect-[4/6]">
                      <img
                        className="w-full h-full object-cover"
                        src="/images/mamas-refe-3.jpg"
                        alt="Foto de frente. Brazos levantados hacia arriba altura de hombros."
                      />
                    </div>
                    <input
